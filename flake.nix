      ...
      pianoteq8 = with import nixpkgs { system = "x86_64-linux"; };
        stdenv.mkDerivation rec {
          ...
          src = requireFile {
            ...
            message = "Download the file from: https://www.modartt.com/download?file=pianoteq_linux_v841.7z and add it to the nix store manually: nix-store --add-fixed sha256 ./pianoteq_linux_v843.7z";
